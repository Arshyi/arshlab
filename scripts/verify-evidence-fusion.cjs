...
assert.equal(cleanBenzene.evidenceFusion.engines.length, 11, "all eleven evidence engines report")
...
console.log("Verified 11 multi-engine fusion regressions across aromatic rings, saturated rings, formulas, carbonyls, clutter, perspective, occlusion, and OCR noise.")
console.log("Verified eleven independent engine reports, OCR-only confidence caps, topology priority, and winner-versus-runner-up explanations.")
rmSync(outputDirectory, { recursive: true, force: true })
