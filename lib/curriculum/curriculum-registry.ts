...
const CORE_UNITS: CurriculumUnit[] = [
  ...
  },
  {
    ...
    description: "Functional groups, IR identification, organic reactions, and organic structure interpretation.",
    topics: ["Functional Group Identification", "Spectroscopy", "IR Spectroscopy", "Organic Reactions"],
    subtopics: [
      "IR Spectroscopy",
      "Alcohols",
      "Aldehydes",
