...
const CORE_UNITS: CurriculumUnit[] = [
  ...
  },
  {
    ...
    description: "Functional groups, IR identification, and organic structure interpretation.",
    topics: ["Functional Group Identification", "IR Spectroscopy"],
    subtopics: [
      "Alcohols",
      "Aldehydes",
      "Ketones",
  ...
  },
  {
    ...
    topics: ["Thermodynamics", "Kinetics", "IR Spectroscopy"],
    subtopics: ["Calorimetry", "Rate Laws", "Carbonyl Identification", "Aromatic Peaks"],
    suggestedQuestionTypes: ["Short answer", "Explanation prompt"],
  },
]
