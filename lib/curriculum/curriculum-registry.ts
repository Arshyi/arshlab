...
const CORE_UNITS: CurriculumUnit[] = [
  {
    ...
    topics: ["Stoichiometry", "Chemistry Calculations"],
    subtopics: [
      "Mole Calculations",
      "Limiting Reagent",
      "Percent Yield",
    ...
    suggestedQuestionTypes: ["Multiple choice", "Short answer", "Calculation question"],
  },
  {
  ...
  },
  {
    ...
    description: "Functional groups, spectroscopy identification, organic reactions, mechanisms, and organic structure interpretation.",
    topics: [
  ...
  },
  {
    ...
    description: "Lab safety, measurement, titration, glassware, separation techniques, spectroscopy prep, and error analysis.",
    topics: ["Lab Skills", "Laboratory Skills", "Measurement and Data Processing"],
    subtopics: [
      "Titration",
      "Pipetting",
      "Burette Reading",
    ...
    suggestedQuestionTypes: ["Multiple choice", "Lab safety question", "Technique selection", "Error analysis"],
  },
  {
    id: "measurement-data",
    ...
    topics: ["Thermodynamics", "Kinetics", "Spectroscopy", "IR Spectroscopy", "NMR Spectroscopy", "Mass Spectrometry"],
    subtopics: [
      "Calorimetry",
      "Rate Laws",
      "IR Spectroscopy",
