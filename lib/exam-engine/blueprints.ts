...
export const EXAM_BLUEPRINTS: ExamBlueprint[] = [
  {
    ...
    sections: [
      ...
      section("lab-skills", "Lab Skills", "Lab Skills", 1, "laboratory-skills"),
      ...
      section("spectroscopy", "Spectroscopy", "Spectroscopy", 1, "organic-chemistry"),
      section("nmr-spectroscopy", "NMR Spectroscopy", "NMR Spectroscopy", 1, "organic-chemistry"),
      section("mass-spectrometry", "Mass Spectrometry", "Mass Spectrometry", 1, "organic-chemistry"),
  ...
  },
  {
    ...
    sections: [
      ...
      section("lab-skills", "Lab Skills", "Lab Skills", 2, "laboratory-skills"),
      ...
      section("spectroscopy", "Spectroscopy", "Spectroscopy", 2, "measurement-data"),
      section("nmr-spectroscopy", "NMR Spectroscopy", "NMR Spectroscopy", 1, "measurement-data"),
      section("mass-spectrometry", "Mass Spectrometry", "Mass Spectrometry", 1, "measurement-data"),
  ...
  },
  {
    ...
    sections: [
      ...
      section("spectroscopy", "Spectroscopy", "Spectroscopy", 2, "organic"),
      section("nmr-spectroscopy", "NMR Spectroscopy", "NMR Spectroscopy", 1, "organic"),
      section("mass-spectrometry", "Mass Spectrometry", "Mass Spectrometry", 1, "organic"),
  ...
  },
  {
    ...
    sections: [
      ...
      section("spectroscopy", "Spectroscopy", "Spectroscopy", 1, "measurement-data"),
      section("nmr-spectroscopy", "NMR Spectroscopy", "NMR Spectroscopy", 1, "measurement-data"),
      section("mass-spectrometry", "Mass Spectrometry", "Mass Spectrometry", 1, "measurement-data"),
      section("organic-mechanisms", "Organic Mechanisms", "Organic Mechanisms", 1, "organic-chemistry"),
    ],
