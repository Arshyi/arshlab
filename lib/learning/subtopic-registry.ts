...
const TOPIC_ALIASES: Record<string, LearningTopic> = {
  ...
  "lab safety": "Lab Skills",
  "chemistry lab": "Lab Skills",
...
const SUBTOPIC_KEYWORDS: Record<string, string[]> = {
  ...
  Titration: ["titration", "titre", "endpoint", "concordant", "standard solution"],
  Pipetting: ["pipette", "aliquot", "pipette filler"],
  "Burette Reading": ["burette", "buret", "initial reading", "final reading", "titre reading"],
  "Meniscus Reading": ["meniscus", "parallax", "eye level", "bottom of meniscus"],
  Filtration: ["filtration", "filter paper", "filtrate", "residue", "precipitate"],
  Recrystallization: ["recrystallization", "crystallization", "minimum hot solvent", "purify solid"],
  Distillation: ["distillation", "distillate", "condenser", "boiling point"],
  Extraction: ["extraction", "separatory funnel", "organic layer", "aqueous layer"],
  TLC: ["tlc", "thin layer chromatography", "rf", "solvent front", "stationary phase"],
  "IR Sample Prep": ["ir sample", "atr", "background scan", "thin film"],
  "NMR Sample Prep": ["nmr sample", "deuterated solvent", "nmr tube"],
  "Safety Symbols": ["safety symbol", "ghs", "pictogram", "sds", "hazard"],
  PPE: ["ppe", "goggles", "gloves", "lab coat"],
  "Waste Disposal": ["waste", "organic waste", "aqueous waste", "broken glass"],
  "Common Lab Glassware": ["glassware", "beaker", "volumetric flask", "graduated cylinder"],
  "Error Analysis": ["error analysis", "accuracy", "precision", "uncertainty", "common mistake"],
