      ...
      <div className="mx-auto max-w-7xl">
        <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          ...
          <p className="max-w-3xl text-lg leading-relaxed text-muted-foreground">
            ARSHLAB v5.2.0 connects diagnostics, curriculum roadmaps, practice, recovery, study, exams, formula views, solver mastery, mechanism mastery, reaction conditions mastery, spectroscopy mastery, lab skills mastery, adaptive study mode, browser-local OCR and structure-shape recognition, Synthesis Explorer, and the Reaction Explorer knowledge graph into one adaptive learning view.
          </p>
        </motion.div>
