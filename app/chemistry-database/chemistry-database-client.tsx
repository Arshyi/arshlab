        ...
        <Card className="rounded-2xl">
          <CardContent className="flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                The v4.2.1 layer now includes local compounds, spectra, reactions, mechanisms, solvers, formulas, curriculum roadmaps, context-aware deep links, and refined 2D structure hooks for
