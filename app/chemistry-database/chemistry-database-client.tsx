        ...
        <Card className="rounded-2xl">
          <CardContent className="flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                The v7.1.0 layer now includes local compounds, spectra, reactions, mechanisms, reaction conditions, lab techniques, solvers, formulas, curriculum roadmaps, context-aware deep links, adaptive study progress, reaction graph links, scene-understood scanner molecule crops, perspective-normalized scanner crops, chemistry-first structure isolation, global shape reconstruction, candidate graph generation, global graph optimization, consensus graph solving, canonical graph hashes, chemistry intelligence, a 100+ compound reference graph library, functional-group hierarchy, scaffold recognition, local property summaries, deterministic explain-why reasoning, and visual graph debugging, plus synthesis pathway traversal, spectroscopy explorer hooks, layout-polished periodic table hooks, and refined 2D structure hooks for
