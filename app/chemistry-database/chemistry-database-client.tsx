        ...
        <Card className="rounded-2xl">
          <CardContent className="flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                The v6.0.0 layer now includes local compounds, spectra, reactions, mechanisms, reaction conditions, lab techniques, solvers, formulas, curriculum roadmaps, context-aware deep links, adaptive study progress, reaction graph links, perspective-normalized scanner crops, chemistry-first structure isolation, candidate graph generation, global graph optimization, canonical graph hashes, ring-closure recovery, chemical graph validation, edge pruning, multi-engine scanner evidence fusion, atom-centered graph reconstruction, calibrated aromatic-ring scanner hooks, and visual graph debugging, plus synthesis pathway traversal, spectroscopy explorer hooks, layout-polished periodic table hooks, and refined 2D structure hooks for
