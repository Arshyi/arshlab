...
export const metadata: Metadata = {
  ...
  description:
    "Explore deterministic connections between ARSHLAB compounds, reactions, mechanisms, virtual lab experiments, spectroscopy, orbitals, formulas, practice, curriculum topics, and learning paths.",
}
