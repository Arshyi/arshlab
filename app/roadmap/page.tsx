  ...
  return (
    <div className="min-h-screen px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl">
          ...
          <Card className="rounded-2xl border-green-500/20 bg-green-500/5">
            ...
            <CardContent>
              <p className="text-sm leading-relaxed text-muted-foreground">
                Now available: unified mastery scoring, adaptive recommendations, study plans,
                learning health dashboards, exam readiness, smart recovery targeting, and stored achievement unlocks.
              </p>
            </CardContent>
          </Card>
        </motion.div>
        ...
        >
          ARSHLAB v3.5.0 - Adaptive Learning Engine
        </motion.p>
      </div>
    </div>
  )
