...
const features = [
  ...
  },
  {
    ...
    description: "Upload or capture a private snapshot, isolate the drawing, recognize atom labels, names and formulas, reconstruct its graph locally, and inspect every diagnostic stage.",
