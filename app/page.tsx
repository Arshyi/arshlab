...
const features = [
  ...
  },
  {
    ...
    description: "Upload or capture a private snapshot, deskew the chemistry canvas, isolate structure from clutter, validate molecular graphs, recover rings, then inspect evidence-fusion results.",
