...
const features = [
  ...
  },
  {
  ...
  },
    {
      ...
      description: "Upload or capture a private snapshot, validate the molecular graph, skip unreliable interpretations, then open chemistry intelligence and study links.",
