...
const features = [
  ...
  },
  {
    ...
    description: "Upload or capture a private snapshot, automatically isolate the chemistry drawing, reconstruct its molecular graph locally, and inspect every diagnostic stage.",
