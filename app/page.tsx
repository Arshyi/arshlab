...
const features = [
  ...
  },
  {
    ...
    description: "Upload or capture a private snapshot, isolate chemistry from clutter, recover rings with local gap-closure logic, then inspect graph and evidence-fusion results.",
