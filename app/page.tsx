...
const features = [
  ...
  },
  {
    ...
    description: "Upload or capture a private snapshot, isolate chemistry from clutter, validate/prune molecular graphs, recover rings, then inspect evidence-fusion results.",
