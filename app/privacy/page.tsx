...
const sections = [
  ...
  },
  {
    ...
    body: "The v5.6.0 Structure Scanner processes uploaded images and accepted camera snapshots locally in the browser. Candidate-region generation, border suppression, bond-length scoring, multi-crop fallback, image variants, OCR, molecular graphs, evidence fusion, overlays, and optional overlay PNG export remain local. Original images, rejected crops, selected crops, OCR text, atom positions, graph geometry, and engine votes are not uploaded to ARSHLAB servers, Supabase, OpenRouter, or an external AI API. Images are not permanently stored or included in local scan history. Local history stores only match labels, source labels, confidence, functional-group labels, timestamps, and corrections.",
  },
  {
